...
class UserRegistrationSerializer(BaseUserRegistrationSerializer):
    ...
    class Meta:
        model = User
        fields = ['first_name', 'last_name', 'phone', 'role', 'image', 'token', 'last_login', 'is_staff']  # '__all__'
...
class CurrentUserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        или ответ, включая поля, явно указанные выше. '''
        # fields = ['first_name', 'last_name', 'phone', 'role', 'is_staff']
        fields = ['id', 'email', 'username', 'first_name', 'last_name', 'phone', 'role', 'image', 'token', 'last_login',
                  'is_staff']
